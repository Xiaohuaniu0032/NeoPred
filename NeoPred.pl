...
my ($name,$tvcf,$nbam,$outdir,$py2_bin,$py3_bin,$samtools,$bedtools,$ref);
...
print SH "perl $Bin/extract_hla_reads_from_nbam.pl $nbam $name $ref $samtools $bedtools $outdir/$name\n";
...
print SH "perl $Bin/reformat_HLA_typing_result.pl $$outdir/$name/hla.raw.result.tsv $name $outdir/$name\n";
...
print SH "$py3_bin $Bin/tools/NeoPredPipe/NeoPredPipe.py -I $outdir/$name/vcf -H $hla_result -o $outdir/$name -n $name -c 0 -E 8 9 10\n";
